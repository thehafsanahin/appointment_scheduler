...
class TimeSlotsControllerTest < ActionController::TestCase
  ...
  test "should create time_slot" do
    assert_difference('TimeSlot.count') do
      post :create, time_slot: { day: @time_slot.day, duration: @time_slot.duration, end_time: @time_slot.end_time, patient_count: @time_slot.patient_count, start_time: @time_slot.start_time }
    end
  ...
  test "should update time_slot" do
    patch :update, id: @time_slot, time_slot: { day: @time_slot.day, duration: @time_slot.duration, end_time: @time_slot.end_time, patient_count: @time_slot.patient_count, start_time: @time_slot.start_time }
    assert_redirected_to time_slot_path(assigns(:time_slot))
  end
